...
#define MSM_ION_SF_SIZE		0x6E00000 /* 80MB */
#define MSM_ION_CAMERA_SIZE     MSM_PMEM_ADSP_SIZE   /* 18MB -> 16MB */
#define MSM_ION_MM_FW_SIZE	0x200000 /* (2MB) */
#define MSM_ION_MM_SIZE		0x3E00000 /* 54MB -> 61MB */
...
#define MSM_ION_AUDIO_SIZE	MSM_PMEM_AUDIO_SIZE    /* (4MB) */
...
#if (defined(CONFIG_MSM_BT_POWER) || defined(CONFIG_MSM_BT_POWER_MODULE))
