...
/* begin: added by h00131430 for identify hardware version */
#define USBVID_S7								0x12d1
#define USBVID_GOOGLE								0x18d1

/* we can assigned PID in 0x3607~3806 */

/*< Begin : add modem func  chenhui c00181104, 20110429> 	*/
/* enable adb */
#define USBPID_S7_S7_MSC_ADB								0x360E
#define USBPID_S7_S7_MTP_ADB_MSC						0x360F
#define USBPID_S7_S7_DIAG_ADB_MSC						0x3610
#define USBPID_S7_S7_DIAG_ADB							0x3611
#define USBPID_S7_S7_DIAG_ADB_GMDM_GNMEA				0x3612
#define USBPID_S7_S7_DIAG_ADB_GMDM_GNMEA_MSC			0x3613
#define USBPID_S7_S7_MTP_ADB_DIAG_GMDM_GNMEA_MSC_RMNET		0x3614
#define USBPID_S7_S7_ADB_ACCESSORY					0x2D00
#define USBPID_S7_S7_DIAG_ADB_MSC_RNDIS				0x3616
#define USBPID_S7_S7_RNDIS_ADB                                         	0x3618

/* disable adb */
#define USBPID_S7_S7_MSC							0x361E
#define USBPID_S7_S7_MTP_MSC						0x361F
#define USBPID_S7_S7_DIAG_MSC					0x3620
#define USBPID_S7_S7_DIAG							0x3621
#define USBPID_S7_S7_DIAG_GMDM_GNMEA			0x3622
#define USBPID_S7_S7_DIAG_GMDM_GNMEA_MSC		0x3623
#define USBPID_S7_S7_MTP_DIAG_GMDM_GNMEA_MSC_RMNET	0x3624
#define USBPID_S7_S7_ACCESSORY					0x3625
#define USBPID_S7_S7_DIAG_MSC_RNDIS				0x3626
#define USBPID_S7_S7_RNDIS						0x3628
/*< End : add modem func  chenhui c00181104, 20110429> 	*/
#define USBPID_S7_S70_FASTBOOT					0x36dd


/* begin: added by h00131430 for identify hardware version */
/* New definitions for supporting multiple sub-projects */
#define  S7_HWID_L1(X1)    			(defined(CONFIG_MACH_MSM8X60_SURF_##X1))
#define  S7_HWID_L2(X1, X2)    		(defined(CONFIG_MACH_MSM8X60_SURF_##X1) \
										 && defined(CONFIG_MACH_MSM8X60_SURF_##X1##_##X2))
#define  S7_HWID_L3H(X1, X2, X3)    (defined(CONFIG_MACH_MSM8X60_SURF_##X1) \
										 && defined(CONFIG_MACH_MSM8X60_SURF_##X1##_##X2) \
    									 && (  CONFIG_MACH_MSM8X60_SURF_##X1##_##X2##_HWVER \
    									    >= CONFIG_MACH_MSM8X60_SURF_##X1##_##X2##_HWVER_##X3))
#define  S7_HWID_L3L(X1, X2, X3)    (defined(CONFIG_MACH_MSM8X60_SURF_##X1) \
                                         && defined(CONFIG_MACH_MSM8X60_SURF_##X1##_##X2) \
                                         && (  CONFIG_MACH_MSM8X60_SURF_##X1##_##X2##_HWVER \
                                                <= CONFIG_MACH_MSM8X60_SURF_##X1##_##X2##_HWVER_##X3))
#define  S7_HWID_L3D(X1, X2, X3, X4) (S7_HWID_L3H(X1, X2, X3) && S7_HWID_L3L(X1, X2, X4))
/* end: added by h00131430 for identify hardware version */
...
struct gpio_i2c_adpt_platform_data {
	...
	void (*gpio_i2c_adpt_config_gpio)(unsigned int gpio_scl,unsigned int gpio_sda);
};
...
//void msm_snddev_poweramp_on(void); // /* delete by zhangjie z00176551 */
