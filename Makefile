...
#
#/*add proc entry for pass appsboot version to user space, ligang 00133091, (Suchangyu.KF21980) 2009-4-14, start*/
KBUILD_CFLAGS   += -DS7_KERNEL_VERSION=\"$(S7_KERNEL_VERSION)\"
#/*TODO: APPSBOOT_VERSION should be set in bootloader */
#/*add proc entry for pass appsboot version to user space, ligang 00133091, 2009-4-14, end*
#
